...
var (
	rgxIPv4NoMask = regexp.MustCompile(`^(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9]?[0-9])$`)
...
func ParseList(input string) []string {
	...
	for _, line := range lines {
		...
		if rgxIPv4.MatchString(tempLine) {
			ipAddresses = append(ipAddresses, tempLine)
			continue
		}
